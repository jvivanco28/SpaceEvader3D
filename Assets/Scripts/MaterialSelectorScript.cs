...
public class MaterialSelectorScript : MonoBehaviour 
{
	public static string BOX1_MAT = "Materials/Box1Mat";
	public static string BOX2_MAT = "Materials/Box2Mat";
	public static string BOX3_MAT = "Materials/Box3Mat";
	public static string BOX4_MAT = "Materials/Box4Mat";
	public static string BOX5_MAT = "Materials/Box5Mat";
	public static string BOX6_MAT = "Materials/Box6Mat";
	public static string BOX7_MAT = "Materials/Box6Mat";
